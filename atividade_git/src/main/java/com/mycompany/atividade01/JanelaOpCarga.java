 ...
 * @author Ewerton
 */
public class JanelaOpCarga implements ActionListener {
    ...
    public void carregaJanela() {
        ...
        jan.setTitle("Veículos de Carga");
    ...
    public void actionPerformed(ActionEvent act) {
        if (act.getSource().equals(btSair)) {
            ...
            JanelaCarga jpass = new JanelaCarga();
            jpass.carregaJanela();
        } else if (act.getSource().equals(btConsultar)) {
            JanelaCargaConsulta jpass = new JanelaCargaConsulta();
            jpass.carregaJanela();
        } else if (act.getSource().equals(btImprimir)) {
            JanelaCargaImpressao jpass = new JanelaCargaImpressao();
            jpass.carregaJanela();
        }
